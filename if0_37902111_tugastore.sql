...
-- Tempo de geração: 09-Jan-2025 às 05:23
...
(1, 'Produto Top Xuxa', '29.99', 'Top Xuxa', 'image/t-shirt.png', 20),
(2, 'Produto Top Xuxa', '29.99', 'Nunca mais e sabado', 'image/topxuxa.png', 20);
...
INSERT INTO `users` (`id_user`, `nome`, `email`, `password`, `role`) VALUES
(1, 'Fonseca', 'goncalofonseca2001@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 1),
(2, 'Piedade', 'ricardopiedade2005@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 1),
(3, 'vdvd', 'goncalofonseca1310@hotmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 2);
...
ALTER TABLE `carrinho`
  ...
  ADD CONSTRAINT `carrinho_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`) ON DELETE CASCADE;
